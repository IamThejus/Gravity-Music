...
class MediaKitPlayer extends AudioPlayerPlatform {
  ...
  MediaKitPlayer(super.id) {
    ...
    // GRAVITY PATCH: media_kit hardcodes `cache-on-disk=yes`, whose on-disk
    // cache file can't be created for HTTP audio streams on some Linux setups
    // ("mkv: Failed to create file cache"), which then makes the start-of-track
